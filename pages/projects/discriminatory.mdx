...
For this, I had to use _react-intl_ (Format.JS), combined with static JSON that corresponded to each page. I didn't version those JSON files, so it was wiser not to cache them. Each view/page loaded its JSON Localisation files and passed it dynamically to the _react-intl_ provider by updating the localisation store.
...
Like I said, my most ambitious project yet. Working on this project made me see a bigger picture I wasn't aware. It allowed me to learn new experiences in things like GraphQL JIT, scalability, project management, risk management and mitigation, and more. I'm happy I worked on this and would love to do it again!
...
<p align='center'>Arabic registration page</p>

![Complete profile page](/discriminatory/6.png)

<p align='center'>Complete profile page</p>

![Unregistered user settings](/discriminatory/8.png)

<p align='center'>Unregistered user settings</p>

![Custom file upload component](/discriminatory/9.png)

<p align='center'>Custom file upload component</p>

![Home page of user with no posts in feed](/discriminatory/10.png)

<p align='center'>Home page of user with no posts in feed</p>

![Profile of user with 0 posts](/discriminatory/11.png)

<p align='center'>Profile of user with 0 posts</p>

![Profile with 1 post, comments expanded](/discriminatory/12.png)

<p align='center'>Profile with 1 post, comments expanded</p>
...
<p align='center'>Profile editor screen</p>

![You can follow other users to get their posts in your feed](/discriminatory/16.png)

<p align='center'>You can follow other users to get their posts in your feed</p>

![You can disable ads in the settings](/discriminatory/18.png)

<p align='center'>You can disable ads in the settings</p>

![Location search](/discriminatory/19.png)

<p align='center'>Location search</p>

![You can delete posts and pin posts to your profile](/discriminatory/20.png)

<p align='center'>You can delete posts and pin posts to your profile</p>
