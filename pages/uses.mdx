...
- Adobe Audition Pro for audio editing.
- Adobe Premiere Pro for video editing.
- Figma is my main website prototype design tool.

# Work and Experiments

This is a list of all the tools I'm actively using, have used before, or have learned but haven't had the chance to use in a real world project yet. I currently have a thing for TypeScript 😀. (This is more of a ref for myself, probably outdated lol)
