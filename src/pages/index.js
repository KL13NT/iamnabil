		...
		<>
			...
			<Layout>
				...
				<p>
					...
					<a href='https://twitter.com/Nabil_Tharwat16'>Twitter</a> are your
					best channels. You can also find me on{' '}
				...
				<p>
					By mid-2020 I managed to collect all four frontend-related
					FreeCodeCamp certificates, published my first{' '}
				...
				<p>
					<span className='u-bold'>
						What roles would you be most excited about?
					</span>
					<br />
					UXE, DX, and Frontend.
				</p>
				<p>
					<span className='u-bold'>
						What role attributes would you be most excited about in your next
						job?
					</span>
					<br />
				...
				<p>
					<span className='u-bold'>
						What company attributes would you be most excited about in your next
						job?
					</span>
					<br />
					Flexible work arrangements, mentorship culture, inclusive workspace,
				...
				<p>
					<span className='u-bold'>What are you reading right now?</span>
					<br />
				...
				<p>
					<span className='u-bold'>What words of wisdom do you live by?</span>
					<br />
				...
				<p>
					<span className='u-bold'>
						What are obstacles you've overcome to become who you are now?
					</span>
					<br />
