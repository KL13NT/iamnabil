...
export default () => (
	<div className="c-socialContainer">
		...
		<a className='u-unstyledLink' data-id='AngelCo' href="https://angel.co/nabil-tharwat">
		...
		<a className='u-unstyledLink' href="https://docs.google.com/document/export?format=pdf&amp;id=1VL4_iTKO712R-H7S5_3_PkuG1ed97eoIJUMjo9T9noE">
